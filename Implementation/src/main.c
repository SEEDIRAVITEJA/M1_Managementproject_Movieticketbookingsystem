...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : RRR\n",id2);
        printf("\t Customer  : %s\n",name);
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 for RRR\n\n");
	printf("\t\t\tpress 2 for KGF-2\n\n");
	printf("\t\t\tpress 3 for RADHE-SHYAM\n");
...
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name :KGF-2\n",id2);
        printf("\t Customer  : %s\n",name);
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : RADHE_SHYAM \n",id2);
        printf("\t Customer  : %s\n",name);
